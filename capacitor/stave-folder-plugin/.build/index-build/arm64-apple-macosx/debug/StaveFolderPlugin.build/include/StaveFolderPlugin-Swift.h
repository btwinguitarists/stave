...
#ifndef STAVEFOLDERPLUGIN_SWIFT_H
#define STAVEFOLDERPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StaveFolderPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// same notebook.
SWIFT_CLASS("_TtC17StaveFolderPlugin17StaveFolderPlugin")
@interface StaveFolderPlugin
@end
